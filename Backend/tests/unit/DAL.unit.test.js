...
describe("mock DELETE question", () => {
	...
	test("should throw error on invalid argument", async () => {
		await expect(dal.deleteQuestion("hi")).rejects.toThrow("Invalid Argument");
	});
...
describe("mock DELETE stance", () => {
	...
	test("should throw error on invalid argument", async () => {
		await expect(dal.deleteStance("hi")).rejects.toThrow("Invalid Argument");
	});
...
describe("mock DELETE category", () => {
	...
	test("should throw error on invalid argument", async () => {
		await expect(dal.deleteCategory("hi")).rejects.toThrow("Invalid Argument");
	});
