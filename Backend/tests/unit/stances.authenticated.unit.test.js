	...
	test("should return 200 OK with stance filter", () => {
		...
		return request(app)
			...
			.then((response) => {
				...
				expect(db.getStancesFiltered).toHaveBeenCalledWith(true, 2, null, null);
			});
	});
	...
	test("should return 200 OK with issue filter", () => {
		...
		return request(app)
			...
			.then((response) => {
				expect(response.statusCode).toBe(200);
				expect(response.body).toEqual(fakeStances);
				expect(db.getStancesFiltered).toHaveBeenCalledWith(true, null, 1, null);
			});
	});
	...
	test("should return 200 OK with empty issue filter", () => {
		...
		return request(app)
			...
			.then((response) => {
				expect(response.statusCode).toBe(200);
				expect(response.body).toEqual([]);
				expect(db.getStancesFiltered).toHaveBeenCalledWith(true, null, 2, null);
			});
	});
	...
	test("should return 200 OK with party filter", () => {
		...
		return request(app)
			...
			.then((response) => {
				...
				expect(db.getStancesFiltered).toHaveBeenCalledWith(true, null, null, 1);
			});
	});
