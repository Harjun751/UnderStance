...
('National Identity'), -- CategoryID = 1
('Governance'),        -- CategoryID = 2
('Cultural Policy'),   -- CategoryID = 3
('Public Engagement'), -- CategoryID = 4
('Defense');           -- CategoryID = 5
...
-- Issue 1: Change national anthem to hips's don't lie
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Mandate weekly rhythm & dance classes for MPs', 'On political grace', 2);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Rename National Day Rally to Shake it Summit', 'On national branding', 1);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Tax breaks for streaming Shakira''s hits', 'On cultural subsidies', 3);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Ban lying in politics—hips must also not lie', 'On political integrity', 2);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Use interpretive dance to explain the national budget', 'On fiscal transparency', 4);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Replace Ministry of Culture with Ministry of Groove', 'On cultural priorities', 3);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Include salsa dance in national service training', 'On national fitness', 5);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Declare Shakira''s birthday a national holiday', 'On public holidays', 4);
...
INSERT INTO "Issue" ("Description", "Summary", "CategoryID")
VALUES ('Install a dance floor in Parliament', 'On parliamentary renovations', 2);
