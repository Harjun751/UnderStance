                ...
                <div className="features-list">
                    ...
                    <div className="feature-item">
                        ...
                        <div className="feature-text">
                            ...
                            <p className="feature-description">
                                Receive a personalized breakdown of your
                                political leanings with clear visualizations!
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="feature-item">
                        ...
                        <div className="feature-text">
                            ...
                            <p className="feature-description">
                                Read & Explore the various parties reply to each
                    ...
                    <div className="feature-item">
                        ...
                        <div className="feature-text">
                            ...
                            <p className="feature-description">
                                Fine tune each question’s importance based on
