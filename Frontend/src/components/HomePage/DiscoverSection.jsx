                    ...
                    <div className="discover-items">
                        ...
                        >
                            ...
                            <p className="discover-description">
                                Answer a series of questions to uncover your
                        ...
                        >
                            ...
                            <p className="discover-description">
                                No time to complete the quiz? You can still read
                                each party’s reply here!
                            </p>
                        </button>
                    </div>
                </div>
                            ...
                            <div className="discover-card-content">
                                <div className="discover-intro">
                                    <div className="discover-icon">
                                        <i className="icon-white icon-lg">
                                ...
                                <div className="discover-grid">
                                    <div className="discover-box red-box">
                                        <h4 className="discover-box-title red-text">
                                    ...
                                    <div className="discover-box gray-box">
                                        <h4 className="discover-box-title gray-text">
                                            How it works:
                                        </h4>
                                        <ul className="discover-list">
                                            <li>
                                                <i className="icon-gray">
                                                    <CgRadioCheck />
                                                </i>
                                                <span>
