					...
					return (
						...
						>
							<div className="question-header">
								<h2>
									Q{question.IssueID}: <br className="qn-break" />{" "}
									{question.Summary}
								</h2>
								<div className="header-right">
									{userAnswers[question.IssueID] && (
										...
										>
											{userAnswers[question.IssueID].charAt(0).toUpperCase() +
												userAnswers[question.IssueID].slice(1)}
										</span>
									)}
                        ...
                        {(() => {
									...
									return (
										<div key={question.IssueID} className="question-details">
                                        ...
                                        {userAnswer === "skip" && (<div className="alignment-info">You did not answer this question.</div>)}
                                            <StanceItem parties={parties} stancesForQuestion={stancesForQuestion} />
										</div>
									);
								})()}
						</div>
