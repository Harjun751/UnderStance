	...
	if (!issues.length)
		return (
			<div className="content">
				Loading... The servers are all free-tier so the loading might be pretty
				long, give it patience :)
			</div>
		);
			...
			<div className="content">
				...
				<div id="content-container" key={currentIssue.IssueID}>
                    ...
                    <div className="quote-container">
                        ...
                        <span className="big-quote main-question">{currentIssue.Description}</span>
                        <span className="floaty-quotey big-quote">”</span>
                    </div>
